<template>
  <div v-show="isShown">
    <right-side-bar-component
      ...
      init-event-name="open-general-donation-page"
  ...
  computed: {
    headerName() {
      if (this.isAddNewDialog) {
        return 'Add new General Donation';
      }
      return this.isNewMode ? 'New General Donation' : `${this.name}`;
    },
